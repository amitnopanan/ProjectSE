		...
		<div id="wrapper" class="container">
						...
						<ul>
							...
							<li><a href="#">Skin Care</a>
								<ul>
									...
									<li><a href="Non_SkinCareLotion.php">Lotiob@Emulation</a></li>
			...
			<section  class="homepage-slider" id="home-slider">
				<div class="flexslider">
					<ul class="slides">
						<li>
							<a href="Non_Promotion1.php"><img src="Picture/Promotion/Promotion1.jpg" alt="" /></a>
						</li>
						<li>
							<a href="Non_Promotion2.php"><img src="Picture/Promotion/Promotion2.jpg" alt="" /></a>
