1. Install Database in localhost
2. Copy file in folder Code and Put it in C:\xampp\htdocs\
3. Run code in Web browser The first page is Non_main.php 
( 127.0.0.1/---Folder_Name---/Non_main.php )
